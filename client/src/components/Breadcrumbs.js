...
const Breadcrumbs = () => {
  ...
  const routes = [
    ...
    { path: "/products", breadcrumb: "Collections" },
    { path: "/products/:category", breadcrumb: params.category && params.category.slice(0, 1).toUpperCase() + params.category.slice(1) },
    { path: "/products/:category/:title", breadcrumb: params.title },
  ];
